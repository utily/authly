...
const algorithms: {
	[name: string]:
		| ((keys: [Uint8Array | string | undefined, Uint8Array | string | undefined]) => Algorithm | undefined)
		| undefined
} = {}
export function register(
	name: AlgorithmName,
	create: (keys: [Uint8Array | string | undefined, Uint8Array | string | undefined]) => Algorithm | undefined
) {
