...
export class HS extends Symmetric {
	get name(): Name {
		return ("HS" + this.length) as Name.Symmetric
	}
	...
	constructor(private readonly length: "256" | "384" | "512", key: Uint8Array | string) {
		...
		this.key = crypto.subtle.importKey("raw", key, { name: "HMAC", hash: { name: "SHA-" + this.length } }, false, [
			"sign",
			"verify",
		])
	}
...
register(
	"HS256",
	(keys: [Uint8Array | string | undefined, Uint8Array | string | undefined]) =>
		(keys[0] && new HS("256", keys[0])) || undefined
)
register(
	"HS384",
	(keys: [Uint8Array | string | undefined, Uint8Array | string | undefined]) =>
		(keys[0] && new HS("384", keys[0])) || undefined
)
register(
	"HS512",
	(keys: [Uint8Array | string | undefined, Uint8Array | string | undefined]) =>
		(keys[0] && new HS("512", keys[0])) || undefined
)
