...
export namespace fixtures {
	...
	export const token = {
		signed:
			"eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3MDQxMTAwMDAsImlzcyI6InVua25vd24iLCJhdWQiOiJ1bmtub3duIiwiZXhwIjoxNzA0MTM5MjAwLCJmb28iOjEyM30.SlPqPC5F2lu27JaBEZOqeA3YIyS1Jcas--zGhmVz7d2P15QevAmW_0qnDtpDUamgORIV-T9UY7BsLDafahsuG9hBhDb3uIkQKSZWEymosmJMrrDgnCdPGNYvSBHO-lNPYGex3-UdgbNXJuynTNKZ9yzZ7JNAybIrWr1FA2q6FQE",
		unsigned:
			"eyJhbGciOiJub25lIiwidHlwIjoiSldUIn0.eyJpYXQiOjE3MDQxMTAwMDAsImlzcyI6InVua25vd24iLCJhdWQiOiJ1bmtub3duIiwiZXhwIjoxNzA0MTM5MjAwLCJmb28iOjEyM30.",
	}
}
